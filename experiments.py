...
def ocr(img):
    ...
    print(pytesseract.image_to_string(Image.open(img), config='-l eng --psm 11'))
    print(pytesseract.image_to_boxes(Image.open(img)))
    print(pytesseract.image_to_data(Image.open(img) , config='-l eng --psm 11'))
    print(pytesseract.image_to_osd(Image.open(img)))

def segment(img):
    img = cv2.imread("./CargoContainerImages/crop002.jpg")
...
if __name__ == '__main__':
    img = "./CargoContainerImages/crop002.jpg"
    segment(img)
    ocr(img)